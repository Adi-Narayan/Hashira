...
const Navbar = () => {
    ...
    const [profileOpen, setProfileOpen] = useState(false); // ✅ NEW: click-based toggle
    ...
    return (
        <div className='flex items-center justify-between py-5 pt-18 pb-14 font-medium mb-8'>
            ...
            <div className='flex items-center gap-6 ml-auto'>
                ...
                {/* ✅ FIXED: click-toggle dropdown instead of hover */}
                        ...
                        <>
                            ...
                            <div className='absolute right-0 pt-4 z-20'>
                                <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded shadow-md'>
                                    <p onClick={() => { navigate('/profile'); setProfileOpen(false); }} className='cursor-pointer hover:text-black'>My Profile</p>
                                    <p onClick={() => { navigate('/orders'); setProfileOpen(false); }} className='cursor-pointer hover:text-black'>Orders</p>
