    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          ...
          <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type='text' placeholder='State'/>
        </div>
        <div className='flex gap-3'>
          <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type='text' placeholder='Pin Code'/>
          <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type='text' placeholder='Phone Number'/>
        </div>
      </div>
      {/* Right Side */}
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            <div onClick={()=>setMethod('upi')} className='flex items-center gap-3 border bg-white p-2 px-3 cursor-pointer'>
