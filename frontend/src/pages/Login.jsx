  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
      ...
      {currentState === 'Forgot Password'
        ? <input onChange={(e) => setNewPassword(e.target.value)} value={newPassword} type="password" className='w-full px-3 py-2 border border-gray-800' placeholder='New Password' />
      ...
      {currentState !== 'Forgot Password' && (
        <div className='w-full flex justify-between text-sm mt-[-8px]'>
          <p onClick={() => setCurrentState('Forgot Password')} className='cursor-pointer'>Forgot password?</p>
          {currentState === 'Login'
      ...
      <button className='bg-black text-white font-light px-8 py-2 mt-4 hover:cursor-pointer'>
